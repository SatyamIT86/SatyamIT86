...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/SatyamIT86)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:pandeysatyam9833@gmail.com)
...
- 🌱 Deep expertise in **Flutter & Dart**, with strong command of state management (**GetX, BLoC/Cubit, Provider**), Dio + JWT interceptors, Firebase, Google Maps, and native UPI payments
- 🤖 Previously built AI-driven production systems at **Filament AI** — real-time face recognition, Face KYC (liveness detection), Docker alerting
- 📍 Based in **Mumbai, India**
- 🎓 Pursuing **MCA** part-time alongside full-time development work
- 📫 Reach me at **pandeysatyam9833@gmail.com**
...
![BLoC](https://img.shields.io/badge/BLoC/Cubit-02569B?style=flat-square&logo=flutter&logoColor=white)
...
![Dio](https://img.shields.io/badge/Dio-02569B?style=flat-square&logo=dart&logoColor=white)
...
![Profile Metrics](https://raw.githubusercontent.com/SatyamIT86/SatyamIT86/main/github-metrics.svg)

<br/>

![Contribution Snake](https://raw.githubusercontent.com/SatyamIT86/SatyamIT86/output/github-contribution-grid-snake-dark.svg)

</div>

> ⚠️ **One-time setup needed:** these two images are generated by GitHub Actions and committed straight into your repo — that's what makes them reliable (no more "Failed to retrieve contributions" errors, since nothing hits a third-party live server when someone views your profile). See the setup note at the bottom of this file for the two workflow files to add.
...
**Flutter Developer** @ Capritech Global Services *(Apr 2026 – Present)*
- Architected GauBook end-to-end while contributing to BpoJobs.ai and SalonKart
- Owned the full product lifecycle — requirement analysis, system structuring, deployment to Play Store & App Store

**Application Developer (Freelance)** @ Filament AI *(Oct 2025 – Mar 2026)*
- Built real-time features with WebSocket, Socket.io, and MongoDB Change Streams
- Designed secure REST APIs with JWT authentication and RBAC
- Integrated AI-driven systems: face recognition, Face KYC, attendance tracking, video analytics
- Containerized services with Docker & Docker Compose

**Desktop Support Engineer** @ Allied Digital Services *(Jul 2024 – Mar 2026)*
- L1/L2 technical support for Microsoft products and enterprise systems
